...
//    bard.inject(this, 'ExternalAccountService', '$httpBackend', '$q', 'CONSTANTS', 'JwtInterceptorService', 'auth', 'UserService', '$rootScope')
...
//  })
//
//  describe('should call api ', function() {
//
//    afterEach(function() {
...
//    var promise = service.linkExternalAccount('unsupported', 'callback')
